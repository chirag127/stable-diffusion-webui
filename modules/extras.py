...
from modules import errors, images, sd_models, sd_models_config, sd_vae, shared
    ...
    if save_metadata and add_merge_recipe:
        merge_recipe = {
            ...
            "secondary_model_hash": (
                secondary_model_info.sha256 if secondary_model_info else None
            ),
            "tertiary_model_hash": (
                tertiary_model_info.sha256 if tertiary_model_info else None
            ),
