...
from modules import (errors, images, infotext_versions, processing,
                     prompt_parser, script_callbacks, shared, ui_tempdir)
    ...
    *lines, lastline = x.strip().split("\n")
    ...
    if shared.opts.infotext_styles != "Ignore":
        ...
        if ("Hires prompt" in res or "Hires negative prompt" in res) and (
            ...
            hr_prompt, hr_negative_prompt = res.get("Hires prompt", prompt), res.get(
                "Hires negative prompt", negative_prompt
            )
